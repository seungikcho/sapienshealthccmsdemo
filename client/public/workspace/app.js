...
const S = {
  ...
  ptStatus: 'all', ptSort: 'name', ptProvider: 'all', ptSelected: {}, ptExportMenu: false,
  workItemView: null,
  ftDetailId: null,
  ...
  <div style="padding:20px 30px 70px;max-width:1140px;margin:0 auto;width:100%;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;gap:10px;">
      ...
      <div style="display:flex;align-items:center;gap:8px;flex:1;justify-content:flex-end;">
        ...
        <div style="position:relative;">
          <button data-action="pt-export-open" style="display:flex;align-items:center;gap:7px;padding:7px 14px;border-radius:10px;font-size:12.5px;font-weight:600;cursor:pointer;transition:background .15s,color .15s,border-color .15s;${someSelected?'background:var(--accent);color:#fff;border:1px solid transparent;':'background:var(--panel);color:var(--text-3);border:1px solid var(--border);'}" class="${someSelected?'approve-btn':'edit-btn'}">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            Export
            ${someSelected?`<span style="background:rgba(255,255,255,.22);border-radius:5px;padding:1px 6px;font-size:11px;font-weight:800;">${selIds.length}</span>`:''}
  ...
  <div style="padding:24px 30px 70px;max-width:1140px;margin:0 auto;width:100%;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:18px;gap:20px;">
      ...
      <div style="display:flex;gap:5px;flex:none;align-items:center;">
        ...
        <button data-action="care-plan-open" class="nav-btn" style="display:flex;align-items:center;gap:9px;padding:9px 14px;border-radius:10px;font-size:13px;font-weight:600;background:var(--panel-2);color:var(--text-2);border:1px solid var(--border);cursor:pointer;transition:background .15s;">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.63A2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"/></svg>
          Followup Call
        </button>
      </div>
...
document.getElementById('app').addEventListener('click',e=>{
  ...
  if(act!=='pt-export-open') S.ptExportMenu=false;
  if(act==='pt-export-open'){S.ptExportMenu=!S.ptExportMenu;render();return;}
  if(act==='pt-export-close'){render();return;}
