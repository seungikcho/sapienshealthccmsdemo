...
*/
import { FileStack, ListTodo, LogIn, Mail, Sparkles } from "lucide-react";
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(420px,0.98fr)] lg:items-center lg:gap-8">
            <div className="max-w-[40rem]">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                <a
                  href="/patients"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#c8b7ff] px-6 py-3 text-base font-semibold text-[#17120d] transition duration-300 hover:-translate-y-0.5 hover:bg-[#d6caff]"
                >
                  <LogIn className="h-4 w-4" />
