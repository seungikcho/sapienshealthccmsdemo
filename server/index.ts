...
async function startServer() {
  ...
  app.get("/api/auth/status", (req, res) => {
    res.json({
      authenticated:
        Boolean(req.session.googleTokens) || Boolean(req.session.loggedIn),
  ...
  app.post(
    ...
    upload.fields([{ name: "labReport" }, { name: "notes" }]),
    (req, res) => {
      ...
      if (!files?.labReport?.[0] || !files?.notes?.[0]) {
        res
          .status(400)
          .json({ error: "Both labReport and notes PDFs are required." });
        return;
      }
...
%%EOF`;
      ...
      res.setHeader(
        "Content-Disposition",
        `attachment; filename="referral-${Date.now()}.pdf"`
      );
  ...
  const LAB_TESTS = [
    {
      ...
      description:
        "Measures red and white blood cells, hemoglobin, hematocrit, and platelets to evaluate overall health and detect disorders.",
      indication: "Anemia, infection, inflammation, hematologic disorders",
      price: "$10 – $29",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "14-test panel covering kidney function, liver enzymes, electrolytes, glucose, and protein levels.",
      indication: "Routine health screening, kidney/liver disease monitoring",
      price: "$14 – $40",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Measures total cholesterol, LDL, HDL, and triglycerides to assess cardiovascular risk.",
      indication: "Cardiovascular risk assessment, dyslipidemia monitoring",
      price: "$15 – $45",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Reflects average blood glucose over the past 2–3 months, used to diagnose and monitor diabetes.",
      indication: "Diabetes diagnosis and management",
      price: "$20 – $50",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Primary screening test for thyroid dysfunction. Elevated TSH indicates hypothyroidism; suppressed TSH suggests hyperthyroidism.",
      indication: "Thyroid disorder screening and monitoring",
      price: "$20 – $60",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "8-test panel covering glucose, calcium, electrolytes, and kidney function markers.",
      indication: "Kidney function, electrolyte balance, glucose monitoring",
      price: "$10 – $30",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Examines urine for color, clarity, pH, protein, glucose, and signs of infection or kidney disease.",
      indication: "UTI, kidney disease, diabetes screening",
      price: "$5 – $20",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Measures how long blood takes to clot. Used to monitor warfarin therapy and evaluate bleeding disorders.",
      indication: "Anticoagulation monitoring, coagulation disorders",
      price: "$10 – $35",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Measures 25-hydroxyvitamin D to assess vitamin D status and deficiency.",
      indication: "Vitamin D deficiency, bone health, immune function",
      price: "$30 – $80",
      turnaround: "1–2 days",
    },
    {
      ...
      description:
        "Sensitive marker of systemic inflammation. Elevated in infection, autoimmune disease, and cardiovascular risk.",
      indication: "Infection, inflammation, cardiovascular risk stratification",
      price: "$15 – $40",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Measures iron stores in the body. Low ferritin is the earliest indicator of iron deficiency anemia.",
      indication: "Iron deficiency anemia, iron overload",
      price: "$20 – $55",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Identifies bacterial species causing a urinary tract infection and determines antibiotic sensitivity.",
      indication: "Suspected urinary tract infection, recurrent UTI",
      price: "$25 – $65",
      turnaround: "2–3 days",
    },
    {
      ...
      description:
        "Panel measuring AST, ALT, alkaline phosphatase, bilirubin, and albumin to assess liver health.",
      indication: "Liver disease, hepatitis, medication monitoring",
      price: "$15 – $45",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Blood test used to screen for prostate cancer and monitor treatment response.",
      indication: "Prostate cancer screening in men 50+",
      price: "$25 – $60",
      turnaround: "Same day",
    },
    {
      ...
      description:
        "Detects bacteria or fungi in the bloodstream, used to diagnose sepsis and bacteremia.",
      indication: "Suspected bacteremia, sepsis, high fever of unknown origin",
      price: "$30 – $80",
      turnaround: "1–5 days",
    },
  ];
  ...
  app.post("/api/lab-test/search", (req, res) => {
    ...
    const scored = LAB_TESTS.map(t => {
      const score = tokens.reduce((acc, tok) => {
        if (t.keywords.some(k => k.includes(tok) || tok.includes(k)))
          return acc + 2;
  ...
  app.post("/api/notes/generate", (req, res) => {
    ...
    if (!patientName || !transcript) {
      res
        .status(400)
        .json({ error: "patientName and transcript are required." });
      return;
    }
    ...
    const vitals =
      "BP: 120/78 mmHg  |  HR: 72 bpm  |  Temp: 98.6°F  |  SpO₂: 98%  |  Wt: per chart";
