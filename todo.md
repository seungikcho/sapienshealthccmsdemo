...
- [ ] 현재 홈페이지 상태를 최신 헤드라인 반영본 기준으로 체크포인트 저장
- [ ] 웹사이트 그림체와 어울리는 6초 제품 애니메이션 콘셉트와 장면 구성을 정리
- [ ] 의사, 외부 데이터 연결, 태스크 리스트, 자동 드래프팅, AI assistant 움직임이 포함된 6초 영상 생성
- [ ] 생성된 애니메이션 결과물을 검토하고 사용자에게 전달
